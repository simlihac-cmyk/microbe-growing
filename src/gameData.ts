...
export const HARD_STAGES: OrganismStage[] = [
  ...
  { level: 21, name: "강독성 세균", cost: storedOrganism(19, 1), successRate: 35, salePrice: 600_000, protectCost: 17, drop: null, storable: true },
  { level: 22, name: "돌연변이 세균", cost: storedOrganism(21, 2), successRate: 32, salePrice: 800_000, protectCost: 20, drop: null, storable: true },
  { level: 23, name: "폭주 세균", cost: material("mitochondria", 12), successRate: 32, salePrice: 1_100_000, protectCost: 22, drop: null },
  { level: 24, name: "방사능 세균", cost: storedOrganism(22, 1), successRate: 30, salePrice: 1_500_000, protectCost: 23, drop: null },
  { level: 25, name: "코로나", cost: material("hostNutrients", 15), successRate: 40, salePrice: 800_000, protectCost: 23, drop: null },
  { level: 26, name: "살모넬라", cost: atp(1_000), successRate: 55, salePrice: 3_600_000, protectCost: null, drop: null },
  { level: 27, name: "비행 세균", cost: material("unidentifiedMatter", 2), successRate: 45, salePrice: 5_000_000, protectCost: null, drop: null },
  { level: 28, name: "우주로간 세균", cost: { kind: "free" }, successRate: 20, salePrice: null, protectCost: null, drop: null },
...
export const EASY_STAGES: OrganismStage[] = [
  ...
  { level: 21, name: "강독성 세균", cost: storedOrganism(19, 1), successRate: 45, salePrice: 202_000, protectCost: 17, drop: null, storable: true },
  { level: 22, name: "돌연변이 세균", cost: storedOrganism(21, 2), successRate: 45, salePrice: 320_000, protectCost: 20, drop: null, storable: true },
  { level: 23, name: "폭주 세균", cost: material("mitochondria", 8), successRate: 45, salePrice: 460_000, protectCost: 22, drop: null },
  { level: 24, name: "방사능 세균", cost: storedOrganism(22, 1), successRate: 45, salePrice: 600_000, protectCost: 23, drop: null },
  { level: 25, name: "코로나", cost: material("hostNutrients", 15), successRate: 40, salePrice: 800_000, protectCost: 23, drop: null },
  { level: 26, name: "살모넬라", cost: atp(10_000), successRate: 55, salePrice: 3_600_000, protectCost: null, drop: null },
  { level: 27, name: "비행 세균", cost: material("unidentifiedMatter", 2), successRate: 45, salePrice: 5_000_000, protectCost: null, drop: null },
  { level: 28, name: "우주로간 세균", cost: { kind: "free" }, successRate: 20, salePrice: null, protectCost: null, drop: null },
  { level: 29, name: "아스트로파지", cost: { kind: "none" }, successRate: null, salePrice: null, protectCost: null, drop: null },
];
...
export const COMBINE_RECIPES: CombineRecipe[] = [
  ...
  },
  {
    id: "host-to-protect",
    label: "숙주의 영양분으로 방지권",
    material: "hostNutrients",
    hardAmount: 6,
    easyAmount: 6,
    reward: { kind: "protect", amount: 10 },
  },
  {
    id: "matter-to-protect",
    label: "미확인 물질로 방지권",
    material: "unidentifiedMatter",
    hardAmount: 4,
    easyAmount: 3,
    reward: { kind: "protect", amount: 11, easyAmount: 9, hardAmount: 11 },
  },
];
